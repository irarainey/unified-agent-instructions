...
> The decision to adopt these defensive standards is recorded in
> [ADR 0008](../../docs/adrs/0008-adopt-defensive-shell-scripting-standards.md).
> This file is the detailed ruleset that decision refers to.
